...
public class CustomThreadPool implements CustomExecutor {
    ...
    public CustomThreadPool(int coreThreads, int maxThreads, long idleTimeout, TimeUnit timeUnit, int minIdle, int queueCapacity, RejectedExecutionHandler rejectionHandler) {
